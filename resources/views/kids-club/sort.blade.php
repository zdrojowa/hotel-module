            ...
            <div class="col-md-12">
                <div class="card" id="app">
                    <div class="card-header clearfix">
                        <h4 class="card-title float-left">Sortuj plany zajęć</h4>
                        <a href="{{route('HotelModule::schedules', ['hotel' => $hotel->id])}}" class="btn btn-primary float-right">
                            <i class="mdi mdi-keyboard-backspace"></i> Do listy
                        </a>
                    </div>
                    <div class="card-body">
                        <list name="hotels-schedule" hotel="{{ $hotel->id }}">
                            {{ csrf_field() }}
                        </list>
                    </div>
                </div>
